...
@pytest.mark.anyio
async def test_creat_post_success(client: AsyncClient):
    ...
    response = await client.post(
        '/api/posts',
        json={"title": "Test post", "content": "This is the content"},
        headers=headers,
    )
...
@pytest.mark.anyio
async def test_create_post_unauthorised(client: AsyncClient):
    response = await client.post(
        "/api/posts",
